...
import type { MainlineEntry, RunHistory, RunRecord } from "./types";
 ...
 *  `against_via` name the ref each run was reached by, when it was one.
 *  `history` and `mainline` are measured over the run's own repository. */
