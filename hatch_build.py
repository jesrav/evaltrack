...
# Unsubscripted, because hatchling changed how many type parameters the
# interface takes in 1.32.1 and again in 1.32.4, and a build runs whichever
# hatchling is newest, not the locked one.
